...
const char* NML[15] = { "Тор Сын Одина", "Муфаса Лева", "Георгий Анатольевич", "Электрик Толя", "софьсщсвто", 
						"Джокер Константин", "Олег Великий", "аромтвл", "Шлёпа Русский кот", "рввлв овооов", 
						"Белодед Гринюк", "Янг Лин", "Асапр флз", "Лил Чича", "Пельмени БАбушка Аня"};
