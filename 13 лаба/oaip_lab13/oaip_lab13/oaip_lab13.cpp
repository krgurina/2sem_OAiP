...
void menu()
{
	...
	cout << "6 - Очистить кучу(доп 1)" << endl;
	cout << "7 - Запись в файл(доп 2)" << endl;
	cout << "8 - Вывод из файла(доп 2)" << endl;
	cout << "9 - Объединить кучи(основа)" << endl;

	cout << "10 - Количество четных элементов(доп 3)" << endl;
	cout << "11 - Количество нечетных элементов(доп 3)" << endl;

	cout << "12 - Сумма всех элементов(доп 1)" << endl;
	cout << "0 - Выход" << endl;
}
//-------------------------------
