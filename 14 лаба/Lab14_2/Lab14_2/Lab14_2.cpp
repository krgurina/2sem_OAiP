// ================================ Доп 2, вариант 6 ================================
// Использовать в проекте функции мультипликативного и модульного хеширования.
#include "Header.h"
#include <iostream>
using namespace std;
struct AAA
...
int main()
{
	...
	for (;;)
	{
		...
		cout << "2 - добавление элемента мультипликативным методом" << endl;
		cout << "3 - добавление элемента методом модульного деления" << endl;
		...
		case 4: {  cout << "введите ключ для удаления" << endl;
			cin >> k;
			H.deleteByKey(k);
		}  break;
		case 5: {  cout << "введите ключ для поиска" << endl;
			cin >> k;
			if (H.search(k) == NULL)
